...
export const socialLinks = [
    ...
    },
    {
        name: 'GitHub',
        iconUrl: github,
        link: 'https://github.com/yashtripathi08',
    },
    {
        name: 'LinkedIn',
        iconUrl: linkedin,
        link: 'https://www.linkedin.com/in/yashtripathi7',
    }
];
...
export const projects = [
    {
        ...
        theme: 'btn-back-blue',
        name: 'HATTORI',
        description: 'Hattori is a captivating 2D action RPG where you step into the shoes of Hattori. Set on a mysterious island, you’ll battle monsters, solve puzzles, and face a boss. With its nostalgic retro-style graphics, this game is a treat for classic RPG enthusiasts!',
        link: 'https://github.com/yashtripathi08/hattori-',
    },
    {
        iconUrl: AvalancheRush,
        theme: 'btn-back-red',
        name: 'Avalanche Rush',
        description: 'Avalanche rush is an endless runner game, where the player has to flee from an avalanche while avoiding obstacles, it is inspired by the well-known game "Subway Surfers" but with the addition of a multiplayer mode.',
        link: 'https://github.com/yashtripathi08/Avalanche-Rush',
    },
    {
        iconUrl: favicon,
